                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <ul class="list-unstyled">
                            <li><i class="fas fa-check text-success"></i> Basic CRM setup</li>
                            <li><i class="fas fa-check text-success"></i> 1 month support</li>
                          </ul>
                        </td>
                        <td>$99</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <ul class="list-unstyled">
                            <li><i class="fas fa-check text-success"></i> Advanced CRM setup</li>
                            <li><i class="fas fa-check text-success"></i> 3 months support</li>
                          </ul>
                        </td>
                        <td>$199</td>
                        <td><a href="#" class="btn btn-primary btn-sm">Select Pack</a></td>
